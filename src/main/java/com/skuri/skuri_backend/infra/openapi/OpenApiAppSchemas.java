...
public final class OpenApiAppSchemas {
    ...
    @Schema(name = "AppNoticeUnreadCountApiResponse", description = "공통 API 응답 포맷")
    public record AppNoticeUnreadCountApiResponse(
            @Schema(description = "요청 성공 여부")
            boolean success,
            @Schema(description = "성공 시 응답 데이터", nullable = true)
            AppNoticeUnreadCountResponse data,
            @Schema(description = "에러 메시지", nullable = true)
            String message,
            @Schema(description = "에러 코드", nullable = true)
            String errorCode,
    ...
    @Schema(name = "AppNoticeReadApiResponse", description = "공통 API 응답 포맷")
    public record AppNoticeReadApiResponse(
            @Schema(description = "요청 성공 여부")
            boolean success,
            @Schema(description = "성공 시 응답 데이터", nullable = true)
            AppNoticeReadResponse data,
            @Schema(description = "에러 메시지", nullable = true)
            String message,
            @Schema(description = "에러 코드", nullable = true)
            String errorCode,
