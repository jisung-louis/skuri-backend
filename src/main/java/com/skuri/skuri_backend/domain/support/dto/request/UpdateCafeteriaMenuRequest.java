...
public record UpdateCafeteriaMenuRequest(
        ...
        @Schema(
                description = "기존 날짜별 식당 메뉴 맵. menuEntries만으로도 수정할 수 있으며, 둘 다 전달하면 제목 목록이 일치해야 합니다. category key는 메뉴 ID 안정성을 위해 영문/숫자/_/-만 허용합니다. menus에서 비어 있는 카테고리를 생략한 경우는 menuEntries의 빈 배열과 동일하게 취급합니다.",
                example = """
                        {
                          "2026-02-16": {
                            "rollNoodles": ["우동", "김밥"],
