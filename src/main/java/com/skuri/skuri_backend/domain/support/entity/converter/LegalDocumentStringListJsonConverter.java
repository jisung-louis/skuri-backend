...
@Converter
public class LegalDocumentStringListJsonConverter implements AttributeConverter<List<String>, String> {
    ...
    public String convertToDatabaseColumn(List<String> attribute) {
        ...
        try {
            ...
            throw new IllegalArgumentException("법적 문서 문자열 목록 직렬화에 실패했습니다.", e);
        }
    }
    ...
    public List<String> convertToEntityAttribute(String dbData) {
        ...
        try {
            ...
            throw new IllegalArgumentException("법적 문서 문자열 목록 역직렬화에 실패했습니다.", e);
        }
    }
}
