...
env JAVA_HOME=$(/usr/libexec/java_home -v 21) ./gradlew test --tests "com.skuri.skuri_backend.infra.openapi.AdminOpenApiConventionTest" --tests "com.skuri.skuri_backend.infra.openapi.OpenApiResponseExamplesConventionTest"\nenv JAVA_HOME=$(/usr/libexec/java_home -v 21) ./gradlew test --tests "com.skuri.skuri_backend.infra.openapi.OpenApiSuccessSchemaCoverageIntegrationTest" --tests "com.skuri.skuri_backend.infra.openapi.BoardNoticeOpenApiSchemaIntegrationTest" --tests "com.skuri.skuri_backend.infra.openapi.OpenApiUiAvailabilityIntegrationTest"\nenv JAVA_HOME=$(/usr/libexec/java_home -v 21) ./gradlew test --tests "com.skuri.skuri_backend.domain.campus.controller.CampusBannerControllerContractTest" --tests "com.skuri.skuri_backend.domain.campus.controller.CampusBannerAdminControllerContractTest" --tests "com.skuri.skuri_backend.domain.campus.service.CampusBannerServiceTest" --tests "com.skuri.skuri_backend.domain.campus.repository.CampusBannerRepositoryDataJpaTest" --tests "com.skuri.skuri_backend.infra.admin.audit.AdminAuditIntegrationTest" --tests "com.skuri.skuri_backend.infra.auth.AdminApiGuardIntegrationTest" --tests "com.skuri.skuri_backend.infra.openapi.OpenApiSuccessSchemaCoverageIntegrationTest" --tests "com.skuri.skuri_backend.infra.openapi.AdminOpenApiConventionTest" --tests "com.skuri.skuri_backend.infra.openapi.OpenApiResponseExamplesConventionTest"\n./gradlew test --tests "com.skuri.skuri_backend.domain.notification.controller.NotificationControllerContractTest"
