...
- 업로드 파일은 `GET /uploads/**`(`media.storage.url-prefix`)로 공개 제공되며, 잘못된 Bearer 헤더가 있어도 공개 조회를 막지 않는다. 이미지 업로드는 10MB, JPEG/PNG/WebP, 최대 5000x5000px 및 총 20,000,000 픽셀 제한을 둔다.
